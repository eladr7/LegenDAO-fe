...
export default function SnowFall(): React.ReactElement {
    return (
        <div className="hidden fixed top-0 left-0 w-full h-0 overflow-visible z-[200] tablet-2:flex justify-between">
            ...
            <div className="snow-group relative w-1 h-1 grow-0 shrink-0 overflow-visible">
